...
try {
    ...
    String query = "SELECT userID, userPassword, userName, userGender, userEmail FROM user"; // DB에 전송할 쿼리문 생성 목록을 나타내기 위해 SELECT문을 사용했습니다. 
...
%>
<!-- 이벤트 당첨자 버튼 생성 -->
			<a href="userChoose.jsp" class="btn btn-primary pull-right">이벤트 당첨자 3명 추출 결과 보기</a>
		</div>
	</div>
	<!-- 부트스트랩 참조 영역 -->
